...
void ofxImgui::setup(ofEventArgs&)
{
  ...
  style->Colors[ImGuiCol_ChildWindowBg]         = ImVec4(col_win_inact.r / 255.f, col_win_inact.g / 255.f, col_win_inact.b / 255.f, 0.58f);
  ...
  style->Colors[ImGuiCol_FrameBg]               = ImVec4(col_win_inact.r / 255.f, col_win_inact.g / 255.f, col_win_inact.b / 255.f, 1.00f);
  style->Colors[ImGuiCol_FrameBgHovered]        = ImVec4(col_main_back.r / 255.f, col_main_back.g / 255.f, col_main_back.b / 255.f, 0.78f);
  style->Colors[ImGuiCol_FrameBgActive]         = ImVec4(col_main_back.r / 255.f, col_main_back.g / 255.f, col_main_back.b / 255.f, 1.00f);
  style->Colors[ImGuiCol_TitleBg]               = ImVec4(col_win_inact.r / 255.f, col_win_inact.g / 255.f, col_win_inact.b / 255.f, 1.00f);
  style->Colors[ImGuiCol_TitleBgCollapsed]      = ImVec4(col_win_inact.r / 255.f, col_win_inact.g / 255.f, col_win_inact.b / 255.f, 0.75f);
  style->Colors[ImGuiCol_TitleBgActive]         = ImVec4(col_main_back.r / 255.f, col_main_back.g / 255.f, col_main_back.b / 255.f, 1.00f);
  style->Colors[ImGuiCol_MenuBarBg]             = ImVec4(col_win_inact.r / 255.f, col_win_inact.g / 255.f, col_win_inact.b / 255.f, 0.47f);
  style->Colors[ImGuiCol_ScrollbarBg]           = ImVec4(col_win_inact.r / 255.f, col_win_inact.g / 255.f, col_win_inact.b / 255.f, 1.00f);
  style->Colors[ImGuiCol_ScrollbarGrab]         = ImVec4(col_win_popup.r / 255.f, col_win_popup.g / 255.f, col_win_popup.b / 255.f, 0.21f);
  style->Colors[ImGuiCol_ScrollbarGrabHovered]  = ImVec4(col_main_back.r / 255.f, col_main_back.g / 255.f, col_main_back.b / 255.f, 0.78f);
  style->Colors[ImGuiCol_ScrollbarGrabActive]   = ImVec4(col_main_back.r / 255.f, col_main_back.g / 255.f, col_main_back.b / 255.f, 1.00f);
  style->Colors[ImGuiCol_ComboBg]               = ImVec4(col_win_inact.r / 255.f, col_win_inact.g / 255.f, col_win_inact.b / 255.f, 1.00f);
  style->Colors[ImGuiCol_CheckMark]             = ImVec4(col_main_back.r / 255.f, col_main_back.g / 255.f, col_main_back.b / 255.f, 0.80f);
  style->Colors[ImGuiCol_SliderGrab]            = ImVec4(col_win_popup.r / 255.f, col_win_popup.g / 255.f, col_win_popup.b / 255.f, 0.14f);
  style->Colors[ImGuiCol_SliderGrabActive]      = ImVec4(col_main_back.r / 255.f, col_main_back.g / 255.f, col_main_back.b / 255.f, 1.00f);
  style->Colors[ImGuiCol_Button]                = ImVec4(col_win_popup.r / 255.f, col_win_popup.g / 255.f, col_win_popup.b / 255.f, 0.14f);
  style->Colors[ImGuiCol_ButtonHovered]         = ImVec4(col_main_back.r / 255.f, col_main_back.g / 255.f, col_main_back.b / 255.f, 0.86f);
  style->Colors[ImGuiCol_ButtonActive]          = ImVec4(col_main_back.r / 255.f, col_main_back.g / 255.f, col_main_back.b / 255.f, 1.00f);
  style->Colors[ImGuiCol_Header]                = ImVec4(col_main_back.r / 255.f, col_main_back.g / 255.f, col_main_back.b / 255.f, 0.76f);
  style->Colors[ImGuiCol_HeaderHovered]         = ImVec4(col_main_back.r / 255.f, col_main_back.g / 255.f, col_main_back.b / 255.f, 0.86f);
  style->Colors[ImGuiCol_HeaderActive]          = ImVec4(col_main_back.r / 255.f, col_main_back.g / 255.f, col_main_back.b / 255.f, 1.00f);
  style->Colors[ImGuiCol_Column]                = ImVec4(col_win_popup.r / 255.f, col_win_popup.g / 255.f, col_win_popup.b / 255.f, 0.32f);
  style->Colors[ImGuiCol_ColumnHovered]         = ImVec4(col_main_back.r / 255.f, col_main_back.g / 255.f, col_main_back.b / 255.f, 0.78f);
  style->Colors[ImGuiCol_ColumnActive]          = ImVec4(col_main_back.r / 255.f, col_main_back.g / 255.f, col_main_back.b / 255.f, 1.00f);
  style->Colors[ImGuiCol_ResizeGrip]            = ImVec4(col_win_popup.r / 255.f, col_win_popup.g / 255.f, col_win_popup.b / 255.f, 0.04f);
  style->Colors[ImGuiCol_ResizeGripHovered]     = ImVec4(col_main_back.r / 255.f, col_main_back.g / 255.f, col_main_back.b / 255.f, 0.78f);
  style->Colors[ImGuiCol_ResizeGripActive]      = ImVec4(col_main_back.r / 255.f, col_main_back.g / 255.f, col_main_back.b / 255.f, 1.00f);
  ...
  style->Colors[ImGuiCol_PlotLinesHovered]      = ImVec4(col_main_back.r / 255.f, col_main_back.g / 255.f, col_main_back.b / 255.f, 1.00f);
  style->Colors[ImGuiCol_PlotHistogram]         = ImVec4(col_main_text.r / 255.f, col_main_text.g / 255.f, col_main_text.b / 255.f, 0.63f);
  style->Colors[ImGuiCol_PlotHistogramHovered]  = ImVec4(col_main_back.r / 255.f, col_main_back.g / 255.f, col_main_back.b / 255.f, 1.00f);
  style->Colors[ImGuiCol_TextSelectedBg]        = ImVec4(col_main_back.r / 255.f, col_main_back.g / 255.f, col_main_back.b / 255.f, 0.43f);
  style->Colors[ImGuiCol_TooltipBg]             = ImVec4(col_win_popup.r / 255.f, col_win_popup.g / 255.f, col_win_popup.b / 255.f, 0.72f);
  style->Colors[ImGuiCol_ModalWindowDarkening]  = ImVec4(col_win_inact.r / 255.f, col_win_inact.g / 255.f, col_win_inact.b / 255.f, 0.73f);
