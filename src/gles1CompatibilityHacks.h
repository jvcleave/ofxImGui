...
#pragma message "Trying to force-include <GL/gl.h> on rpi. If you get errors, please comment the inclusion below."
...
// I don't know what's happening on RPIs... GL/gl.h inclusion from /user/include/GL is correctly included... but GL_VERSION_1_0 is not set !!!
...
#pragma message "<GLES/gl.h> was loaded somewhere, thus using GL ES 1, which needs some the treaks below to become GL 1 compilable."
#endif
