...
namespace ofxImGui
{
	...
	public:
        ...
        ImFont* addFontFromMemory(void* fontData, int font_size, float fontSize = 13.0f, const ImFontConfig* _fontConfig = nullptr, const ImWchar* _glyphRanges = nullptr, bool _setAsDefaultFont=false );
